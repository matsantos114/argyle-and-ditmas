export const featuredReview = {
    ...
    artist: 'Zadie Flux',
    album: 'Transit Lines',
    image: 'https://images.unsplash.com/photo-1485579149621-3123dd979885?auto=format&fit=crop&w=1400&q=80',
    score: 8.7,
    tags: ['Electronic', 'Downtempo', 'Editorial'],
    readTime: '9 min read',
    summary: 'An immersive survey of the synth auteur’s third record and its obsession with liminal city corners.'
};
...
export const playlists = [
    {
        ...
        cover: 'https://images.unsplash.com/photo-1454922915609-78549ad709bb?auto=format&fit=crop&w=800&q=80',
        link: '#fragments'
    },
    {
        id: 'playlist-02',
